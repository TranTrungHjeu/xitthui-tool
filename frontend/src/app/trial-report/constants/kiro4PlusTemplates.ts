export interface Kiro4PlusCapabilityLevel {
  score: 1 | 2 | 3 | 4 | 5;
  description: string;
}

export const kiro4RecognitionLevels: Kiro4PlusCapabilityLevel[] = [
...
export const kiro4AssemblyLevels: Kiro4PlusCapabilityLevel[] = [
...
export const kiro4ProgrammingLevels: Kiro4PlusCapabilityLevel[] = [
...
export const kiro4CommunicationLevels: Kiro4PlusCapabilityLevel[] = [
